...
<label></label><label></label>
 ...
 <input type="submit" value="Chercher" class="envoyer"/> 
    ...
    <ul id="SlideImages">
        ...
        <div id="BarreLatteraleDroite" >
           <nav>
            <ul class="nav-enumeration">
                ...
                <li>
                    <a href="AccueilHotel.php"><i class="icon-home"></i>🏠 Accueil</a>
                </li>
                <li>
        ...
        <div style="width:100%; background-image: none; float:left; color:white;  margin-bottom:3%">  <h1 style="text-align: center; "> Bienvenue à l'hotel Mariott de Constantine 😄</h1>
     <br/>   <br/> </div>
